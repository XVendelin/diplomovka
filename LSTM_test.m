...
layers = [
    ...
    lstmLayer(256, 'OutputMode', 'sequence') % Increased from 96
    batchNormalizationLayer()                 % Adds stability
    
    lstmLayer(128, 'OutputMode', 'sequence')
    dropoutLayer(0.3)
    
    lstmLayer(64, 'OutputMode', 'sequence')  % Third layer for hierarchy
...
fprintf('Final distance: %.2fm\n', dist_to_goal);
save('lstm_path_follower.mat', 'net', 'obs_radius', 'obs_size', 'res', 'pathWorld');
fprintf('Saved to lstm_path_follower.mat\n');
